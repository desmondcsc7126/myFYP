...
def dataModelling(df_modelling_dict, model_choice, x, modelType, label_class):
    ...
    model_dict = {
        'KNN' :{
            ...
            'main_axis' : [k for k in range(3,40,2)] 
        },
        ...
        'LGR' :{
            ...
            'main_axis' : [0.01, 0.05, 0.1, 0.5, 1, 5, 10]
        },
        ...
        'RFC' :{
            ...
            'main_axis' : [n for n in range(2,30,2)]
        ...
        'XGBoost':{
            ...
            'main_axis' : [n for n in range(3,21)]
        },
