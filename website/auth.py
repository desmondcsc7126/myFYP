...
def sendEmail():
    ...
    if email != None:
        ...
        # link = url_for('auth.confirm_email', _external = True, token = token, username = username)
        # message = "Please click on {} to verify.".format(link)
        # message = "Hi Desmond"
        to = email
        ...
        try:
            ...
            # smtp_server.sendmail(gmail_user, to, message)
            # smtp_server.close()
